 ...
 */
final class Version20210312171153 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE categories ADD produits INT NOT NULL');
        ...
        $this->addSql('ALTER TABLE produits ADD categorie INT NOT NULL, DROP categorie_id');
    }

    public function down(Schema $schema) : void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE categories DROP produits');
        $this->addSql('ALTER TABLE produits ADD categorie_id INT DEFAULT NULL, DROP categorie');
