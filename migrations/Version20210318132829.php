 ...
 */
final class Version20210318132829 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE produits ADD CONSTRAINT FK_BE2DDF8CFAABF2 FOREIGN KEY (id_cat) REFERENCES categories (id)');
